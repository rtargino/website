...
import publicationsPortugueseData from '../../static/autogenerated_files/json_files/publications_port.json' with { type: "json" };
...
const DATA_TYPES = {
    ...
    publications_port: "Publications in Portuguese",
    preprints: "Preprints"
};
...
function handleDropdownChange() {
    ...
    switch (selectedType) {
        ...
        case 'publications':
            ...
            break;
        case 'publications_port':
            currentData = publicationsPortugueseData;
            currentDataType = 'publications_port';
            break;
        case 'preprints':
